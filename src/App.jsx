...
"
      ...
      <section className="py-16 max-w-6xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-6">
          Why The Smoothie Diet <span className="text-green-600">Works</span>
        </h2>
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-16">
          Science-backed solutions designed for real people with busy lives
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            <div className="flex items-start mb-8">
              ...
              <div>
                <h3 className="font-bold text-xl mb-2">
                  Fat-Melting Nutrient Formula
                </h3>
                <p className="text-gray-600">
                  Proprietary blend of 6 metabolic boosters that target stubborn
                  belly fat
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start mb-8">
              ...
              <div>
                <h3 className="font-bold text-xl mb-2">5-Minute Meal Prep</h3>
                <p className="text-gray-600">
                  No cooking skills needed - just blend and enjoy
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Natural ingredients that fight fatigue and improve mental
                  clarity
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Chocolate, berry, and tropical flavors that curb cravings
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <img
              src="https://images.unsplash.com/photo-1490818387583-1baba5e638af?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80"
              alt="Smoothie ingredients"
              className="rounded-xl shadow-xl w-full"
            />
            <div className="absolute -bottom-6 -right-6 bg-green-600 text-white py-4 px-6 rounded-lg shadow-xl">
              <div className="text-2xl font-bold">$27</div>
              <div className="line-through">$47</div>
